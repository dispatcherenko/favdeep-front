  ...
  tabsButtons.forEach((btn) => {
    btn.addEventListener("click", () => {
      const prevActiveButton = document.querySelector(
        ".sign__tabs__button._active-button"
      );
      const prevActiveItem = document.querySelector(
        ".sign__tabs__item._active"
      );
      ...
      <div className="sign__block" onClick={(e) => e.stopPropagation()}>
        <div className="sign__tabs">
          ...
          <div className="sign__nav">
            <button
              class="sign__tabs__button sign__tabs__button-left _active-button"
              data-tab="tab_1"
            >
              по электронной почте
            </button>
            <button
              class="sign__tabs__button sign__tabs__button-right"
              data-tab="tab_2"
            >
              по номеру телефона
            </button>
          ...
          <div className="sign__content">
            <div class="sign__tabs__item _active" id="tab_1">
              <form className="sign__form">
                ...
                <input className="sign__number-input" name="login" />
